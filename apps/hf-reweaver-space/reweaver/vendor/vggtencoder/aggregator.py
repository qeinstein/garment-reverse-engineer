...
from vggtencoder.vitlayers.rope import RotaryPositionEmbedding2D, PositionGetter
from vggtencoder.vitlayers.vision_transformer import vit_small, vit_base, vit_large, vit_giant2
...
# _RESNET_STD = [0.19394169, 0.22065813, 0.21468529]

# # for total male
# _RESNET_MEAN= [0.93212475, 0.92217723, 0.92472974]
# _RESNET_STD= [0.19370156, 0.22141657, 0.21461956]
class Aggregator(nn.Module):
    ...
    Args:
        need square_____________________________
    ...
    def forward(
        ...
        last_feat = torch.cat([frame_intermediates[-1], global_intermediates[-1]], dim=-1)

        del frame_intermediates
        del global_intermediates

        # last_feat = self.reduce_mlp(last_feat)
        
        return last_feat, self.patch_start_idx
